 ...
 */
@WebServlet(name="storeServlet",description = "shoppingcart项目实例", urlPatterns = { "/shop" })
public class StoreServlet extends HttpServlet {
     ...
     */
    public StoreServlet() {
        this.products.put(1, "巧克力");
        this.products.put(2, "棉花糖");
        this.products.put(3, "水果硬糖");
        this.products.put(4, "太妃糖");
        this.products.put(5, "跳跳糖");
    }
